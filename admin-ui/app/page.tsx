...
export default function TestPage() {
  ...
  // کلاس‌دهی اسلات‌های Accordion برای اعمال رنگ روی عنوان‌ها و آیکون‌ها
  const itemClasses = {
    base: "font-vazir",
    heading: "",
    trigger: "",
    indicator: sidebarTextClass, // رنگ فلش/آیکون
    title: `${sidebarTextClass} font-vazir`, // رنگ متن عنوان
    content: ""
  };
    ...
    <div className={`flex min-h-screen transition-colors duration-500 ${sidebarBgClass}`}>
      ...
      >
        ...
        <Accordion itemClasses={itemClasses}>
          <AccordionItem
            key="1"
            aria-label="داشبورد"
            // عنوان به‌صورت ReactNode با کلاس رنگ
            title={<span className={`${sidebarTextClass} font-vazir`}>داشبورد</span>}
          >
          ...
          <AccordionItem
            key="2"
            aria-label="کاربران"
            title={<span className={`${sidebarTextClass} font-vazir`}>کاربران</span>}
          >
            <Button variant="light" fullWidth className={`${sidebarTextClass} font-vazir`}>
              لیست کاربران
            </Button>
          ...
          <AccordionItem
            key="3"
            aria-label="تنظیمات"
            title={<span className={`${sidebarTextClass} font-vazir`}>تنظیمات</span>}
          >
            <Button variant="light" fullWidth className={`${sidebarTextClass} font-vazir`}>
              پروفایل
            </Button>
      ...
      <div className="flex-1 flex flex-col items-center gap-8 p-8 mr-0 md:mr-64">
        ...
        >
          ...
          <p className="mt-2">
            این یک صفحهٔ تست است که از فونت Vazir Regular برای محتوای فارسی استفاده می‌کند.
          </p>
          ...
          >
            <Card className="mt-6 shadow-lg font-vazir">
              ...
              <CardBody>
                این یک کارت نمونه است برای بررسی استایل‌ها و فونت‌ها.
              </CardBody>
            </Card>
          </motion.div>
